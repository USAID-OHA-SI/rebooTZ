...
# GLOBAL VARIABLES --------------------------------------------------------
  ...
  genie_path <- "Data/Genie_PSNU_IM_Tanzania_Daily_d8a6b9b0-9f02-456e-ad48-78f420d4d4b5.zip"
...
# MUNGE -------------------------------------------------------------------
  ...
  df_sub <-  tidylog::inner_join(df_sub, df_ptnr, by = "mech_code")
...
# VIZ - ACHIEVEMENT -------------------------------------------------------
  ...
  plot_achv(unique(df_achv_viz$partner)[4], FALSE)
